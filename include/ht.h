...
ht_strptr_t *ht_strptr_create(const ht_str_options_t *);
void ht_strptr_destroy(ht_strptr_t *);
ht_strset_t *ht_strset_create(const ht_str_options_t *);
void ht_strset_destroy(ht_strset_t *);
...
void ht_strptr_insert(ht_strptr_t *, const char *, void *);
void ht_strptr_remove(ht_strptr_t *, const char *);
bool ht_strset_add(ht_strset_t *, const char *);
void ht_strset_remove(ht_strset_t *, const char *);
...
void *ht_strptr_get(ht_strptr_t *, const char *);
bool ht_strset_contains(ht_strset_t *, const char *);
...
ht_enum_t *ht_strptr_enum_create(ht_strptr_t *);
bool ht_strptr_enum_next(ht_enum_t *, const char **, void **);
void ht_strptr_enum_destroy(ht_enum_t *);
ht_enum_t *ht_strset_enum_create(ht_strset_t *);
bool ht_strset_enum_next(ht_enum_t *, const char **);
void ht_strset_enum_destroy(ht_enum_t *);
